...
class coursecategory_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform = $this->_form;
        $mform->addElement('header', '', get_string('markinmanagerscoursecats', 'block_ned_marking'), '');
        $mform->addElement('static', 'description', '', get_string('markinmanagerscoursecatsdesc', 'block_ned_marking'));
        ...
        $categories = block_ned_marking_get_course_category_tree();

        $c1->text = block_ned_marking_category_tree_form($categories,
